                    ...
                    if p.tag.POS == 'NOUN':
                        ...
                        if (case, number) == ("gent", "sing") or number == "plur":
                            if p.inflect({"plur", "nomn"}) is not None:
                                ...
                                ru_text[ind] = p.inflect({"sing", "nomn"}).word
                        else:
                        ...
                        if ind != 0 and self.morph.parse(ru_text[ind - 1])[0].tag.POS == 'NOUN':
                            ...
                            if number == 'plur':
                                ...
                                noun_gender = self.morph.parse(ru_text[ind - 1])[0].tag.gender
                                ru_text[ind - 1] = p.inflect({number, noun_gender, "nomn"}).word + ' ' + ru_text[ind - 1]
                            ru_text[ind] = ''
                        else:
                            ru_text[ind] = p.normal_form
                    else:
